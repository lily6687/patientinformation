  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <label class="el-form-item-label">医院名称</label>
        <el-input v-model="query.hospital" clearable placeholder="医院名称" style="width: 185px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
      ...
      <el-dialog :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
          ...
          <el-form-item label="证件号码">
            <el-input v-model="form.nationalid" style="width: 370px;" />
          </el-form-item>
          ...
          <el-form-item label="医院名称">
            <el-input v-model="form.hospital" style="width: 370px;" />
          </el-form-item>
        </el-form>
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column prop="nationalid" label="证件号码" />
...
const defaultForm = { columnId: null, name: null, subjid: null, sex: null, brthdat: null, age: null, wgt: null, hgt: null, nationalid: null, tel: null, addr: null, hospital: null }
export default {
  ...
  data() {
    return {
      ...
      queryTypeOptions: [
        ...
        { key: 'hospital', display_name: '医院名称' }
      ]
    }
  },
  methods: {
